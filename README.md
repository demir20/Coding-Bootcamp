Responsive Portfolio built using Bootstrap adjust to screen size with limited media queries and links to different files via tabs in header. Styled using CSS.
